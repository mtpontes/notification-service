...
resource "aws_s3_object" "publisher_service_object" {
  ...
  source        = "${var.publisher_source_code_zip}.zip"
  etag          = filemd5("${var.publisher_source_code_zip}.zip")
...
resource "aws_s3_object" "dispatcher_service_object" {
  ...
  source        = "${var.dispatcher_source_code_zip}.zip"
  etag          = filemd5("${var.dispatcher_source_code_zip}.zip")
  content_type  = "application/zip"
}